...
|minValue| int | 0 | Set minimum slider value will display for `media_player`, `fan`, and `cover` entities |
|maxValue| int | 100 | Set maximum slider value will display for `media_player`, `fan`, and `cover` entities |
