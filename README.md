...
|minValue| int | 0 | Set minimum value slider will display for `media_player`, `fan`, and `cover` entities |
|maxValue| int | 100 | Set maximum value slider will display for `media_player`, `fan`, and `cover` entities |
